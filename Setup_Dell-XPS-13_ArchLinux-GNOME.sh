...
sudo pacman -S xdg-user-dirs xdg-user-dirs-gtk --noconfirm
xdg-user-dirs-gtk-update
xdg-user-dirs-update
sudo pacman -S arc-solid-gtk-theme arc-gtk-theme --noconfirm
sudo pacman -S base-devel --noconfirm
sudo pacman -S atom mailnag --noconfirm
sudo pacman -S networkmanager networkmanager-openconnect networkmanager-openvpn networkmanager-pptp
...
tar xvf python-autobgch.tar.gz
rm python-autobgch.tar.gz
...
systemctl --global disable pipewire.socket numix-circle-arc-icons-git/ -rvf
...
systemctl --global disable pipewire.socketmkfs.fat -F32 /dev/sda1 ; mkswap /dev/sda2 ; swapon /dev/sda2 ; mkfs.ext4 /dev/sda3 ; mkfs.ext4 /dev/sda4
mount /dev/sda3 /mnt ; mkdir /mnt/{home,boot} ; mount /dev/sda1 /mnt/boot ; mount /dev/sda4 /mnt/home
